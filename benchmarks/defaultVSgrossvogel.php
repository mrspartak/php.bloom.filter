...
require 'other/bloom-filter-php/bloomfilter.php';
define('NL', "<br>\r\n# ");
/*
	grossvogel / bloom-filter-php
	https://github.com/grossvogel/bloom-filter-php
*/
...
for( $i = 0; $i < $number; $i++ )
	$stat['foe']['has']['errors'][] = $foe->check($check[$i]);
...
echo '# <a href="https://github.com/mrspartak/php.bloom.filter" target="_blank">My Bloom</a> VS <a href="https://github.com/grossvogel/bloom-filter-php/">Foe Bloom</a>', NL;
